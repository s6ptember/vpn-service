...
Один VPS. Docker Compose, три долгоживущих сервиса и три one-shot. `docker compose up -d` на чистой машине — весь деплой: руками после него не создаётся ничего.
